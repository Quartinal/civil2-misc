async function XOREncoder(moduleArg = {}) {
  var moduleRtn;
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("xor_encoder.wasm");
    }
    return new URL("xor_encoder.wasm", import.meta.url).href;
  }
