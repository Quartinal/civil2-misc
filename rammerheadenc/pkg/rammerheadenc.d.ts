...
export function buildProxyHref(base_url: string, session_id: string, shuffler: StrShuffler, prefix?: string | null): string;
...
export interface InitOutput {
    ...
    readonly buildProxyHref: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
    ...
    readonly strshuffler_fromDictionary: (a: number, b: number) => [number, number, number];
    readonly strshuffler_generate: (a: bigint) => number;
    readonly strshuffler_shuffle: (a: number, b: number, c: number) => [number, number];
    readonly strshuffler_unshuffle: (a: number, b: number, c: number) => [number, number];
